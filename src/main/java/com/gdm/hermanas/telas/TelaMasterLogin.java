...
public class TelaMasterLogin extends javax.swing.JFrame {
    ...
    private void login() {
        if (txtlogin.getText().equals("pantoja") && new String(txtsenha.getPassword()).equals("pantoja")) {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(480, 355));
        setMinimumSize(new java.awt.Dimension(480, 355));
        setSize(new java.awt.Dimension(480, 355));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/splash.png"))); // NOI18N
        ...
        jButton1.setBackground(new java.awt.Color(124, 165, 84));
